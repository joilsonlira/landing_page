<?php
    ...
    $email = $_POST['email_patrocinador'];
    $empresa = $_POST['empresa_patrocinador'];
    $whatsapp = $_POST['whatsapp_patrocinador'];
    $assunto = 'Quero ser um patrocinador';
    ...
    try{
        ...
        $mailer -> Body = utf8_decode("Nome: <strong>".$nome."</strong></br> E-mail: <strong>" .$email."</strong></br>Empresa: <strong>" .$empresa."</strong></br>WhatsApp: <strong>" .$whatsapp."</strong>");
